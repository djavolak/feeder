<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?=$this->t('Edit ignored categories')?> (<?=$data['ignoredCountPerSupplier']?> total)</h1>
    </div>
</div>
...
<div class="panel panel-primary">
    ...
    <div class="panel-body panel-bodyWhite">
        ...
        <?php endif;?>
        <form action="/category-mapper/saveIgnored/<?=$data['supplierId'];?>/"
              class="inlineForm" method="POST" enctype="multipart/form-data" id="ignoredForm" autocomplete="off">
            <div class="row">
                <div class="col-lg-12">
