<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?=$this->t('External Category Mapper ') . $data['tenantName'] ?? 'No tenant'?></h1>
    </div>
</div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <?php endif; ?>
                                                    <input value="<?=$this->formCatTree($category->getLocalCategory())?>" readonly class="form-control inputDesign" />
